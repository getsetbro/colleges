...
template.innerHTML = `
  <style>
    ...
    button { height: 48px; display: flex; align-items: center; justify-content: space-between; gap: 18px; padding: 0 18px; border: 0; background: var(--color-gold); color: var(--color-on-gold); font: 600 .87rem 'DM Sans', sans-serif; cursor: pointer; }
